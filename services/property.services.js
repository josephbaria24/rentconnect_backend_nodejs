...
class PropertyServices {
    static async createProperty(userId, description, photo, photo2, photo3, legalDocPhoto, legalDocPhoto2, legalDocPhoto3, address, amenities, availableFrom, status, typeOfProperty, location) {
        // Validate location
